    ...
    <div className="mt-10">
      {Data.map((item, index) => (
        <div key={index} className=" grid grid-cols-12 mb-10 md:px-0 px-5 ">
          <div className="md:col-span-3 col-span-12 pr-4 mb-10 md:block flex flex-col items-center">
            <img src={item.bg} className="md:h-40 h-50 w-full object-cover" />
            <div className="md:mt-12  text-[#3B3B3B] text-start w-full">{item.date} </div>
          </div>
